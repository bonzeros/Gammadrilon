...
Проект распространяется только для некоммерческого использования. Коммерческое использование, продажа и интеграция в коммерческие продукты запрещены без письменного разрешения автора.
